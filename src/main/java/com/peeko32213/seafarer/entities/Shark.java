...
public class Shark extends WaterAnimal {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends Shark> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
