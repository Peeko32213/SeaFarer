...
public class BowheadWhale extends WaterAnimal {

    public BowheadWhale(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends BowheadWhale> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
