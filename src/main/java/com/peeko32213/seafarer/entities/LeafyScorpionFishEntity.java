...
public class LeafyScorpionFishEntity extends StatedWaterAnimal implements GeoAnimatable {

    private static final EntityDataAccessor<Boolean> IS_SWALLOWING = SynchedEntityData.defineId(LeafyScorpionFishEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public LeafyScorpionFishEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new LeafyScorpionFishEntity.EatFoodGoal(this));
    ...
    class EatFoodGoal extends Goal {
        ...
        private final LeafyScorpionFishEntity beelzebufo;
        private Entity food;

        private int executionCooldown = 50;


        public EatFoodGoal (LeafyScorpionFishEntity beelzebufo){
    ...
    private boolean isFood(Entity entity) {
        return entity instanceof Mob && !(entity instanceof LeafyScorpionFishEntity) && entity.getBbHeight() <= 1.0F;
    }
    ...
    protected <E extends LeafyScorpionFishEntity> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
