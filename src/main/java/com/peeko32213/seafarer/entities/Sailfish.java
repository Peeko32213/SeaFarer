...
public class Sailfish extends WaterAnimal {

    public Sailfish(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends Sailfish> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
