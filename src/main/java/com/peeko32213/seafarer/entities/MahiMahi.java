...
public class MahiMahi extends WaterAnimal {

    public MahiMahi(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends MahiMahi> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
