...
public class Parrotfish extends SchoolingWaterAnimal {

    public Parrotfish(EntityType<? extends SchoolingWaterAnimal> pEntityType, Level pLevel) {
    ...
    public static boolean canSpawn(EntityType<Parrotfish> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
