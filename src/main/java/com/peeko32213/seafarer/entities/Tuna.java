...
public class Tuna extends WaterAnimal {
    ...
    public Tuna(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends Tuna> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
