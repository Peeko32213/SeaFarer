...
public class ManOWar extends WaterAnimal {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends ManOWar> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
