...
public class WhaleShark extends WaterAnimal {

    public WhaleShark(EntityType<? extends WaterAnimal> entityType, Level level) {
    ...
    public static boolean checkSunfishSpawnRules(EntityType<? extends WhaleShark> pWaterAnimal, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
