...
public class SFBlockstateProvider extends BlockStateProvider {
    ...
    public SFBlockstateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
    ...
    protected void registerStatesAndModels() {
        ...
        this.slabBlock(SFBlocks.AZURE_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.AZURE_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/azure_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.AZURE_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/azure_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.AZURE_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.AZURE_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/azure_sea_glass_tiles"));
        this.simpleBlockItem(SFBlocks.AZURE_SEA_GLASS_TILE_SLAB.get(), existingModel((getName(SFBlocks.AZURE_SEA_GLASS_TILE_SLAB.get()))));
        this.stairsBlock(SFBlocks.AZURE_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/azure_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.AZURE_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/azure_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/azure_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.ROSE_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.ROSE_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/rose_sea_glass_bricks"));
        this.simpleBlockItem(SFBlocks.ROSE_SEA_GLASS_BRICK_SLAB.get(), existingModel((getName(SFBlocks.ROSE_SEA_GLASS_BRICK_SLAB.get()))));
        this.stairsBlock(SFBlocks.ROSE_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/rose_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.ROSE_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.ROSE_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/rose_sea_glass_tiles"));
        this.simpleBlockItem(SFBlocks.ROSE_SEA_GLASS_TILE_SLAB.get(), existingModel((getName(SFBlocks.ROSE_SEA_GLASS_TILE_SLAB.get()))));
        this.stairsBlock(SFBlocks.ROSE_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/rose_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.ROSE_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/rose_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/rose_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.LILAC_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.LILAC_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/lilac_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.LILAC_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/lilac_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.LILAC_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.LILAC_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/lilac_sea_glass_tiles"));
        this.simpleBlockItem(SFBlocks.LILAC_SEA_GLASS_TILE_SLAB.get(), existingModel((getName(SFBlocks.LILAC_SEA_GLASS_TILE_SLAB.get()))));
        this.stairsBlock(SFBlocks.LILAC_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/lilac_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.LILAC_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/lilac_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/lilac_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.SEAFOAM_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.SEAFOAM_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/seafoam_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.SEAFOAM_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/seafoam_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.SEAFOAM_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.SEAFOAM_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/seafoam_sea_glass_tiles"));
        ...
        this.stairsBlock(SFBlocks.SEAFOAM_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/seafoam_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.SEAFOAM_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/seafoam_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/seafoam_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.CHARTREUSE_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.CHARTREUSE_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/chartreuse_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.CHARTREUSE_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/chartreuse_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.CHARTREUSE_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.CHARTREUSE_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/chartreuse_sea_glass_tiles"));
        ...
        this.stairsBlock(SFBlocks.CHARTREUSE_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/chartreuse_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.CHARTREUSE_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/chartreuse_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/chartreuse_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.CITRINE_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.CITRINE_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/citrine_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.CITRINE_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/citrine_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.CITRINE_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.CITRINE_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/citrine_sea_glass_tiles"));
        ...
        this.stairsBlock(SFBlocks.CITRINE_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/citrine_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.CITRINE_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/citrine_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/citrine_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.AMBER_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.AMBER_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/amber_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.AMBER_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/amber_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.AMBER_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.AMBER_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/amber_sea_glass_tiles"));
        this.simpleBlockItem(SFBlocks.AMBER_SEA_GLASS_TILE_SLAB.get(), existingModel((getName(SFBlocks.AMBER_SEA_GLASS_TILE_SLAB.get()))));
        this.stairsBlock(SFBlocks.AMBER_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/amber_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.AMBER_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/amber_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/amber_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.SCARLET_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.SCARLET_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/scarlet_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.SCARLET_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/scarlet_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.SCARLET_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.SCARLET_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/scarlet_sea_glass_tiles"));
        ...
        this.stairsBlock(SFBlocks.SCARLET_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/scarlet_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.SCARLET_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/scarlet_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/scarlet_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.UMBER_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.UMBER_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/umber_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.UMBER_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/umber_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.UMBER_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.UMBER_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/umber_sea_glass_tiles"));
        this.simpleBlockItem(SFBlocks.UMBER_SEA_GLASS_TILE_SLAB.get(), existingModel((getName(SFBlocks.UMBER_SEA_GLASS_TILE_SLAB.get()))));
        this.stairsBlock(SFBlocks.UMBER_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/umber_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.UMBER_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/umber_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/umber_sea_glass_pane_top"));
        ...
        this.slabBlock(SFBlocks.PEARLY_SEA_GLASS_BRICK_SLAB.get(), resourceBlock(getName(SFBlocks.PEARLY_SEA_GLASS_BRICKS.get())), new ResourceLocation(Seafarer.MOD_ID, "block/pearly_sea_glass_bricks"));
        ...
        this.stairsBlock(SFBlocks.PEARLY_SEA_GLASS_BRICK_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/pearly_sea_glass_bricks"));
        ...
        this.slabBlock(SFBlocks.PEARLY_SEA_GLASS_TILE_SLAB.get(), resourceBlock(getName(SFBlocks.PEARLY_SEA_GLASS_TILES.get())), new ResourceLocation(Seafarer.MOD_ID, "block/pearly_sea_glass_tiles"));
        ...
        this.stairsBlock(SFBlocks.PEARLY_SEA_GLASS_TILE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/pearly_sea_glass_tiles"));
        ...
        this.paneBlock(SFBlocks.PEARLY_SEA_GLASS_PANE.get(), new ResourceLocation(Seafarer.MOD_ID, "block/pearly_sea_glass"), new ResourceLocation(Seafarer.MOD_ID, "block/pearly_sea_glass_pane_top"));
        ...
        slabBlock(SFBlocks.CLAM_SHELL_BRICKS_SLAB.get(), resourceBlock(getName(SFBlocks.CLAM_SHELL_BRICKS_SLAB.get())), new ResourceLocation(Seafarer.MOD_ID, "block/clam_shell_bricks"));
        simpleBlockItem(SFBlocks.CLAM_SHELL_BRICKS_SLAB.get(), existingModel((getName(SFBlocks.CLAM_SHELL_BRICKS_SLAB.get()))));

        stairsBlock(SFBlocks.CLAM_SHELL_BRICKS_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/clam_shell_bricks"));
        ...
        slabBlock(SFBlocks.HORN_SHELL_BRICKS_SLAB.get(), resourceBlock(getName(SFBlocks.HORN_SHELL_BRICKS_SLAB.get())), new ResourceLocation(Seafarer.MOD_ID, "block/horn_shell_bricks"));
        simpleBlockItem(SFBlocks.HORN_SHELL_BRICKS_SLAB.get(), existingModel((getName(SFBlocks.HORN_SHELL_BRICKS_SLAB.get()))));

        stairsBlock(SFBlocks.HORN_SHELL_BRICKS_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/horn_shell_bricks"));
        ...
        slabBlock(SFBlocks.SPIKY_SHELL_BRICKS_SLAB.get(), resourceBlock(getName(SFBlocks.SPIKY_SHELL_BRICKS_SLAB.get())), new ResourceLocation(Seafarer.MOD_ID, "block/spiky_shell_bricks"));
        simpleBlockItem(SFBlocks.SPIKY_SHELL_BRICKS_SLAB.get(), existingModel((getName(SFBlocks.SPIKY_SHELL_BRICKS_SLAB.get()))));

        stairsBlock(SFBlocks.SPIKY_SHELL_BRICKS_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/spiky_shell_bricks"));
        ...
        slabBlock(SFBlocks.SPIRAL_SHELL_BRICKS_SLAB.get(), resourceBlock(getName(SFBlocks.SPIRAL_SHELL_BRICKS_SLAB.get())), new ResourceLocation(Seafarer.MOD_ID, "block/spiral_shell_bricks"));
        simpleBlockItem(SFBlocks.SPIRAL_SHELL_BRICKS_SLAB.get(), existingModel((getName(SFBlocks.SPIRAL_SHELL_BRICKS_SLAB.get()))));

        stairsBlock(SFBlocks.SPIRAL_SHELL_BRICKS_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/spiral_shell_bricks"));
        ...
        slabBlock(SFBlocks.SWIRL_SHELL_BRICKS_SLAB.get(), resourceBlock(getName(SFBlocks.SWIRL_SHELL_BRICKS_SLAB.get())), new ResourceLocation(Seafarer.MOD_ID, "block/swirl_shell_bricks"));
        simpleBlockItem(SFBlocks.SWIRL_SHELL_BRICKS_SLAB.get(), existingModel((getName(SFBlocks.SWIRL_SHELL_BRICKS_SLAB.get()))));

        stairsBlock(SFBlocks.SWIRL_SHELL_BRICKS_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/swirl_shell_bricks"));
        ...
        slabBlock(SFBlocks.PYRAMID_SHELL_BRICKS_SLAB.get(), resourceBlock(getName(SFBlocks.PYRAMID_SHELL_BRICKS_SLAB.get())), new ResourceLocation(Seafarer.MOD_ID, "block/pyramid_shell_bricks"));
        simpleBlockItem(SFBlocks.PYRAMID_SHELL_BRICKS_SLAB.get(), existingModel((getName(SFBlocks.PYRAMID_SHELL_BRICKS_SLAB.get()))));

        stairsBlock(SFBlocks.PYRAMID_SHELL_BRICKS_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/pyramid_shell_bricks"));
        ...
        slabBlock(SFBlocks.ALGAE_COBBLESTONE_SLAB.get(), resourceBlock(getName(SFBlocks.ALGAE_COBBLESTONE.get())), new ResourceLocation(Seafarer.MOD_ID, "block/algae_cobblestone"));
        simpleBlockItem(SFBlocks.ALGAE_COBBLESTONE_SLAB.get(), existingModel((getName(SFBlocks.ALGAE_COBBLESTONE_SLAB.get()))));

        stairsBlock(SFBlocks.ALGAE_COBBLESTONE_STAIRS.get(), new ResourceLocation(Seafarer.MOD_ID, "block/algae_cobblestone"));
