...
public class SeaItemTagProvider extends ItemTagsProvider {
    ...
    public SeaItemTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider, CompletableFuture<TagLookup<Block>> completableFuture, @Nullable ExistingFileHelper existingFileHelper) {
...
//        this.copy(BlockTags.SAPLINGS, ItemTags.SAPLINGS);
        ...
        this.copy(SeaBlockTags.SEA_GLASS, SeaItemTags.SEA_GLASS);
        this.copy(SeaBlockTags.SEA_GLASS_PANES, SeaItemTags.SEA_GLASS_PANES);

        this.tag(Tags.Items.GLASS).addTag(SeaItemTags.SEA_GLASS);
        this.tag(Tags.Items.GLASS_PANES).addTag(SeaItemTags.SEA_GLASS_PANES);
