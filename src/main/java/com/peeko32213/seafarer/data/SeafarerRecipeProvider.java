...
import com.peeko32213.seafarer.registry.tags.SeafarerItemTags;
...
import static com.peeko32213.seafarer.registry.SeafarerBlocks.*;
...
public class SeafarerRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        // horseshoe crab
        cooking(SeafarerItems.RAW_HORSESHOE_CRAB.get(), SeafarerItems.COOKED_HORSESHOE_CRAB.get(), consumer);

        // shore crab
        cooking(SeafarerItems.RAW_SHORE_CRAB_LEG.get(), SeafarerItems.COOKED_SHORE_CRAB_LEG.get(), consumer);
