...
public class SFBiomeTagProvider extends net.minecraft.data.tags.BiomeTagsProvider {
    public SFBiomeTagProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pPro, ExistingFileHelper existingFileHelper) {
