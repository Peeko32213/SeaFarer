...
import com.peeko32213.seafarer.registry.SFPaintings;
...
public class SFPaintingTagProvider extends PaintingVariantTagsProvider {

    public SFPaintingTagProvider(PackOutput packOutput, CompletableFuture<Provider> lookupProvider, ExistingFileHelper helper) {
