...
public class SFBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(SFBlocks.CLAM_SHELL_BRICK_SLAB.get())
                .add(SFBlocks.CLAM_SHELL_BRICK_STAIRS.get())
                .add(SFBlocks.CLAM_SHELL_PILLAR.get())

                .add(SFBlocks.HORN_SHELL_BRICKS.get())
                .add(SFBlocks.HORN_SHELL_BRICK_SLAB.get())
                .add(SFBlocks.HORN_SHELL_BRICK_STAIRS.get())
                .add(SFBlocks.HORN_SHELL_PILLAR.get())

                .add(SFBlocks.SPIKY_SHELL_BRICKS.get())
                .add(SFBlocks.SPIKY_SHELL_BRICK_SLAB.get())
                .add(SFBlocks.SPIKY_SHELL_BRICK_STAIRS.get())
                .add(SFBlocks.SPIKY_SHELL_PILLAR.get())

                .add(SFBlocks.SPIRAL_SHELL_BRICKS.get())
                .add(SFBlocks.SPIRAL_SHELL_BRICK_SLAB.get())
                .add(SFBlocks.SPIRAL_SHELL_BRICK_STAIRS.get())
                .add(SFBlocks.SPIRAL_SHELL_PILLAR.get())

                .add(SFBlocks.SWIRL_SHELL_BRICKS.get())
                .add(SFBlocks.SWIRL_SHELL_BRICK_SLAB.get())
                .add(SFBlocks.SWIRL_SHELL_BRICK_STAIRS.get())
                .add(SFBlocks.SWIRL_SHELL_PILLAR.get())

                .add(SFBlocks.PYRAMID_SHELL_BRICKS.get())
                .add(SFBlocks.PYRAMID_SHELL_BRICK_SLAB.get())
                .add(SFBlocks.PYRAMID_SHELL_BRICK_STAIRS.get())
