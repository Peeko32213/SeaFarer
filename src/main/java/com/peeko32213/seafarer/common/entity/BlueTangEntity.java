...
public class BlueTangEntity extends AbstractCustomSchoolingFish implements GeoEntity {


    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public BlueTangEntity(EntityType<? extends AbstractCustomSchoolingFish> pEntityType, Level pLevel) {
