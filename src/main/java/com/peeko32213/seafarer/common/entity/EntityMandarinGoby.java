...
public class EntityMandarinGoby extends WaterAnimal implements GeoAnimatable {
    ...
    public EntityMandarinGoby(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new EntityMandarinGoby.MandarinGobyMoveControl(this);
    }
    ...
    static class MandarinGobyMoveControl extends MoveControl {
        private final EntityMandarinGoby guardian;

        public MandarinGobyMoveControl(EntityMandarinGoby pGuardian) {
            super(pGuardian);
    ...
    protected <E extends EntityMandarinGoby> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
