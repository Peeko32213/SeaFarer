...
import com.peeko32213.seafarer.common.entity.misc.interfaces.Brushable;
...
public class MarineIguanaEntity extends StatedAnimal implements GeoAnimatable, SemiAquatic, Brushable, net.minecraftforge.common.IForgeShearable {
    ...
    protected <E extends MarineIguanaEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
    ...
    public static boolean checkMarineIguanaSpawnRules(EntityType<? extends MarineIguanaEntity> dino, LevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource p_186242_) {
