...
public class EntityFrogfish extends StatedWaterAnimal implements GeoAnimatable {

    private static final EntityDataAccessor<Boolean> IS_SWALLOWING = SynchedEntityData.defineId(EntityFrogfish.class, EntityDataSerializers.BOOLEAN);
    ...
    public EntityFrogfish(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
    ...
    class EatFoodGoal extends Goal {
        ...
        private final EntityFrogfish beelzebufo;
        private Entity food;

        private int executionCooldown = 50;


        public EatFoodGoal (EntityFrogfish beelzebufo){
    ...
    private boolean isFood(Entity entity) {
        return entity instanceof Mob && !(entity instanceof EntityFrogfish) && entity.getBbHeight() <= 1.0F;
    }
    ...
    protected <E extends EntityFrogfish> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
