...
public class ZebraSharkEntity extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(ZebraSharkEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public ZebraSharkEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new ZebraSharkEntity.FileFishMoveControl(this);
    }
    ...
    static class FileFishMoveControl extends MoveControl {
        private final ZebraSharkEntity guardian;

        public FileFishMoveControl(ZebraSharkEntity pGuardian) {
            super(pGuardian);
