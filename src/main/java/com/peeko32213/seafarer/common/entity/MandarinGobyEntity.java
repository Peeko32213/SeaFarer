...
public class MandarinGobyEntity extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(MandarinGobyEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public MandarinGobyEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        ...
        this.moveControl = new MandarinGobyEntity.MandarinGobyMoveControl(this);
    }
    ...
    static class MandarinGobyMoveControl extends MoveControl {
        private final MandarinGobyEntity guardian;

        public MandarinGobyMoveControl(MandarinGobyEntity pGuardian) {
            super(pGuardian);
