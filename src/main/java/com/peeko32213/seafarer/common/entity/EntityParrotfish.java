...
public class EntityParrotfish extends AbstractCustomSchoolingFish implements GeoEntity {


    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public EntityParrotfish(EntityType<? extends AbstractCustomSchoolingFish> pEntityType, Level pLevel) {
    ...
    public static <T extends Mob> boolean canSpawn(EntityType<EntityParrotfish> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
