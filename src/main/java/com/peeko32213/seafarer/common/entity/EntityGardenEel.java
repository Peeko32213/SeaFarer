...
public class EntityGardenEel extends WaterAnimal implements GeoAnimatable {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(EntityGardenEel.class, EntityDataSerializers.INT);
    ...
    private static final EntityDataAccessor<Boolean> RETREATED = SynchedEntityData.defineId(EntityGardenEel.class, EntityDataSerializers.BOOLEAN);
    public float prevRetreatProgress;
    public float retreatProgress;
    private int hideInShellTimer = 0;
    public EntityGardenEel(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
    ...
    protected <E extends EntityGardenEel> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
        if (isInWater()) {
