...
public class ParrotfishEntity extends EnhancedSchoolingWaterAnimal {
    ...
    protected @NotNull BodyRotationControl createBodyControl() {
        ...
        helper.bodyLagStill = 0.23F;
        return helper;
    }

    public ParrotfishEntity(EntityType<? extends EnhancedSchoolingWaterAnimal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new CustomRandomSwimGoal(this, 1, 2, 32, 32, 3));
    ...
    public static boolean canSpawn(EntityType<ParrotfishEntity> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
