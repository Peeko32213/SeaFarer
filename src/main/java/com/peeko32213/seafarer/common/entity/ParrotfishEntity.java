...
public class ParrotfishEntity extends AbstractCustomSchoolingFish implements GeoEntity {


    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public ParrotfishEntity(EntityType<? extends AbstractCustomSchoolingFish> pEntityType, Level pLevel) {
