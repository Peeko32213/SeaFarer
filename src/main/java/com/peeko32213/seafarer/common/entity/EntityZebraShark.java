...
public class EntityZebraShark extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(EntityZebraShark.class, EntityDataSerializers.BOOLEAN);
    ...
    public EntityZebraShark(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new EntityZebraShark.FileFishMoveControl(this);
    }
    ...
    static class FileFishMoveControl extends MoveControl {
        private final EntityZebraShark guardian;

        public FileFishMoveControl(EntityZebraShark pGuardian) {
            super(pGuardian);
    ...
    protected <E extends EntityZebraShark> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
