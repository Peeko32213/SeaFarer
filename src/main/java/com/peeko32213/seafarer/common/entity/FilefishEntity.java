...
public class FilefishEntity extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(FilefishEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public FilefishEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new FilefishEntity.FileFishMoveControl(this);
    }
    ...
    static class FileFishMoveControl extends MoveControl {
        private final FilefishEntity guardian;

        public FileFishMoveControl(FilefishEntity pGuardian) {
            super(pGuardian);
