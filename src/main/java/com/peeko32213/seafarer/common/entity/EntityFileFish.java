...
public class EntityFileFish extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(EntityFileFish.class, EntityDataSerializers.BOOLEAN);
    ...
    public EntityFileFish(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new EntityFileFish.FileFishMoveControl(this);
    }
    ...
    static class FileFishMoveControl extends MoveControl {
        private final EntityFileFish guardian;

        public FileFishMoveControl(EntityFileFish pGuardian) {
            super(pGuardian);
    ...
    protected <E extends EntityFileFish> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
