package com.peeko32213.seafarer.common.entity.misc.navigator;
...
public class AquaticJumperNavigation extends PathNavigation {

    public AquaticJumperNavigation(Mob entitylivingIn, Level worldIn) {
