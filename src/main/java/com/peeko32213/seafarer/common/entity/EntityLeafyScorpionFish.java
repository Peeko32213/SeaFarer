...
public class EntityLeafyScorpionFish extends StatedWaterAnimal implements GeoAnimatable {

    private static final EntityDataAccessor<Boolean> IS_SWALLOWING = SynchedEntityData.defineId(EntityLeafyScorpionFish.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> LURE = SynchedEntityData.defineId(EntityCrab.class, EntityDataSerializers.BOOLEAN);

    private static final RawAnimation IDLE = RawAnimation.begin().thenLoop("animation.leafy_scorpionfish.idle");
    private static final RawAnimation WALK = RawAnimation.begin().thenLoop("animation.leafy_scorpionfish.walk");
    private static final RawAnimation NOM = RawAnimation.begin().thenLoop("animation.leafy_scorpionfish.nom");

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private int eatCooldown = 0;


    public EntityLeafyScorpionFish(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new EntityLeafyScorpionFish.EatFoodGoal(this));
    ...
    class EatFoodGoal extends Goal {
        ...
        private final EntityLeafyScorpionFish beelzebufo;
        private Entity food;

        private int executionCooldown = 50;


        public EatFoodGoal (EntityLeafyScorpionFish beelzebufo){
    ...
    private boolean isFood(Entity entity) {
        return entity instanceof Mob && !(entity instanceof EntityLeafyScorpionFish) && entity.getBbHeight() <= 1.0F;
    }
    ...
    protected <E extends EntityLeafyScorpionFish> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
