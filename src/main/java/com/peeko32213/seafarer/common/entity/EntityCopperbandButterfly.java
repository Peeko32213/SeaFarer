...
public class EntityCopperbandButterfly extends AbstractCustomSchoolingFish implements GeoEntity {


    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public EntityCopperbandButterfly(EntityType<? extends AbstractCustomSchoolingFish> pEntityType, Level pLevel) {
    ...
    public static <T extends Mob> boolean canSpawn(EntityType<EntityBlueTang> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
