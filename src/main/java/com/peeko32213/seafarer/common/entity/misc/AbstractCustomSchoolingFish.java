...
import com.peeko32213.seafarer.common.entity.misc.goal.CustomFollowLeaderGoal;
...
public class AbstractCustomSchoolingFish extends WaterAnimal {
    @Nullable
    private AbstractCustomSchoolingFish leader;
    private int schoolSize = 1;

    public AbstractCustomSchoolingFish(EntityType<? extends AbstractCustomSchoolingFish> p_27523_, Level p_27524_) {
        super(p_27523_, p_27524_);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new CustomFollowLeaderGoal(this));
    }
    ...
    public AbstractCustomSchoolingFish startFollowing(AbstractCustomSchoolingFish p_27526_) {
    ...
    public void addFollowers(Stream<? extends AbstractCustomSchoolingFish> p_27534_) {
    ...
    public static class SchoolSpawnGroupData implements SpawnGroupData {
        public final AbstractCustomSchoolingFish leader;

        public SchoolSpawnGroupData(AbstractCustomSchoolingFish p_27553_) {
