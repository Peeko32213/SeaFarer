...
public class BarreleyeEntity extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(BarreleyeEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public BarreleyeEntity(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new BarreleyeEntity.BarreleyeMoveControl(this);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new RandomLookAroundGoal(this));
        this.goalSelector.addGoal(4, new BarreleyeEntity.BarreleyeAvoidPlayerGoal<>(this, Player.class, 45.0F, 1.33D, 1.33D));
    ...
    static class BarreleyeAvoidPlayerGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        private final BarreleyeEntity ocelot;

        public BarreleyeAvoidPlayerGoal(BarreleyeEntity pOcelot, Class<T> pEntityClassToAvoid, float pMaxDist, double pWalkSpeedModifier, double pSprintSpeedModifier) {
    ...
    static class BarreleyeMoveControl extends MoveControl {
        private final BarreleyeEntity guardian;

        public BarreleyeMoveControl(BarreleyeEntity pGuardian) {
            super(pGuardian);
