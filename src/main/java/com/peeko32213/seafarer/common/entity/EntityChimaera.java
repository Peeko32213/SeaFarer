...
public class EntityChimaera extends WaterAnimal implements GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_ID_MOVING = SynchedEntityData.defineId(EntityChimaera.class, EntityDataSerializers.BOOLEAN);
    ...
    public EntityChimaera(EntityType<? extends WaterAnimal> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
        this.moveControl = new EntityChimaera.FileFishMoveControl(this);
    }
    ...
    static class FileFishMoveControl extends MoveControl {
        private final EntityChimaera guardian;

        public FileFishMoveControl(EntityChimaera pGuardian) {
            super(pGuardian);
    ...
    protected <E extends EntityChimaera> PlayState controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
