...
public class SunfishEntity extends WaterAnimal implements GeoAnimatable {
    ...
    static class MoveHelperController extends MoveControl {
        private final SunfishEntity dolphin;

        public MoveHelperController(SunfishEntity dolphinIn) {
            super(dolphinIn);
