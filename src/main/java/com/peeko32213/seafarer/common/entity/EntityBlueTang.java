...
public class EntityBlueTang extends AbstractCustomSchoolingFish implements GeoEntity {


    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public EntityBlueTang(EntityType<? extends AbstractCustomSchoolingFish> pEntityType, Level pLevel) {
