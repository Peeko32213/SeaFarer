package com.peeko32213.seafarer.common.world.modifiers;

import com.mojang.serialization.Codec;
import com.peeko32213.seafarer.core.registry.SFBiomeFeatures;
...
) implements BiomeModifier
{
    ...
    public Codec<? extends BiomeModifier> codec() {
        return SFBiomeFeatures.ADD_FEATURES_BY_FILTER.get();
    }
}