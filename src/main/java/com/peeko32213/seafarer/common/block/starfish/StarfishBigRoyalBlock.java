...
public class StarfishBigRoyalBlock extends SFWetFloorLayerBlock {

    public StarfishBigRoyalBlock(Properties pProperties) {
        super(pProperties);
    }

    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        //pTooltipComponents.clear();
        MutableComponent mutableComponent = Component.translatable("seafarer.starfish_big_royal").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC);
