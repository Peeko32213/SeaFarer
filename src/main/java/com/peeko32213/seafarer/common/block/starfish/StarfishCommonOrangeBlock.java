...
public class StarfishCommonOrangeBlock extends SFWetFloorLayerBlock {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        MutableComponent mutableComponent = Component.translatable("seafarer.starfish_common_orange").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC);
