...
public class StarfishChocolateChipBlock extends SFWetFloorLayerBlock {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        MutableComponent mutableComponent = Component.translatable("seafarer.starfish_chocolate_chip").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC);
