...
public class SeaBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<VolcanicCoreBlockEntity>> VOLCANIC_CORE = BLOCK_ENTITIES.register("volcanic_core", () -> BlockEntityType.Builder.of(VolcanicCoreBlockEntity::new, SeaBlocks.VOLCANIC_CORE.get()).build(null));
}
