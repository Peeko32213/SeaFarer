...
public class SeafarerEntities {
    ...
    public static final RegistryObject<EntityType<MarineIguana>> MARINE_IGUANA = ENTITY_TYPES.register(
            "marine_iguana", () ->
            EntityType.Builder.of(MarineIguana::new, MobCategory.CREATURE)
                    .sized(1F, 0.75F)
                    .clientTrackingRange(10)
