...
public class SeaFeatures {
    ...
    public static final RegistryObject<Feature<SimpleBlockConfiguration>> GORGONIAN = FEATURES.register("gorgonian", () -> new GorgonianFeature(SimpleBlockConfiguration.CODEC));
