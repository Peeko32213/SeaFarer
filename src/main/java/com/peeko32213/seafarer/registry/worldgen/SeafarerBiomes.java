...
//        context.register(VOLCANIC_ISLAND, volcanicIsland(features, carvers));
    ...
    private static Biome warmReef(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        ...
        SeafarerBiomeGeneration.warmReef(generation);
    ...
    private static Biome floweringBeach(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(features, carvers);
        SeafarerBiomeGeneration.floweringBeach(generation);
    ...
    private static Biome grassyBeach(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(features, carvers);
        SeafarerBiomeGeneration.grassyBeach(generation);
    ...
    private static Biome glassBeach(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(features, carvers);
        SeafarerBiomeGeneration.glassBeach(generation);
    ...
    private static Biome kelpForest(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(features, carvers);
        SeafarerBiomeGeneration.kelpForest(generation);
    ...
    private static Biome tropicalRiver(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(features, carvers);
        SeafarerBiomeGeneration.tropicalRiver(generation);
    ...
    private static Biome volcanicIsland(HolderGetter<PlacedFeature> features, HolderGetter<ConfiguredWorldCarver<?>> carvers) {
        BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(features, carvers);
        SeafarerBiomeGeneration.volcanicIsland(generation);
