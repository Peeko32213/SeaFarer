...
public class SeaPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        register(context, GORGONIANS, SeafarerConfiguredFeatures.GORGONIANS, CountPlacement.of(UniformInt.of(1, 2)), RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        register(context, WARM_REEF_STARFISH, SeafarerConfiguredFeatures.STARFISH, CountPlacement.of(UniformInt.of(1, 2)), RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        ...
        register(context, BEACH_STARFISH, SeafarerConfiguredFeatures.STARFISH, CountPlacement.of(UniformInt.of(1, 2)), RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
        register(context, BEACH_FLOWERS, SeafarerConfiguredFeatures.BEACH_FLOWERS, CountPlacement.of(BiasedToBottomInt.of(3, 30)), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        register(context, BEACHGRASS, SeafarerConfiguredFeatures.BEACHGRASS, CountPlacement.of(ConstantInt.of(1)), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
        createBeachPlantPatch(context, FLOWERING_BEACHGRASS, 4, 8, SeafarerConfiguredFeatures.BEACHGRASS);
        createBeachPlantPatch(context, GRASSY_BEACHGRASS, 6, 18, SeafarerConfiguredFeatures.GRASSY_BEACHGRASS);
        register(context, TALL_BEACHGRASS, SeafarerConfiguredFeatures.TALL_BEACHGRASS, CountPlacement.of(BiasedToBottomInt.of(4, 8)), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
