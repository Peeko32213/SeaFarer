...
import static com.peeko32213.seafarer.data.SFItemModelProvider.prefix;
...
public class SFPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, BEACHGRASS_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.BEACHGRASS), ImmutableList.of(
        ...
        register(context, BEACHGRASS_FAN_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.BEACHGRASS_FAN), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(16),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, SEA_HOLLY_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.SEA_HOLLY), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, SEA_THRIFT_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.SEA_THRIFT), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, COASTAL_LAVENDER_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.COASTAL_LAVENDER), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, COASTAL_WILDFLOWER_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.COASTAL_WILDFLOWER), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, ALGAE_BOULDER_PLACED, configuredFeatures.getOrThrow(SFConfiguredFeatures.ALGAE_BOULDER), ImmutableList.of(
        ...
        register(context, SEA_SHELL_LAND,  configuredFeatures.getOrThrow(SFConfiguredFeatures.SEA_SHELLS),
      ...
      // register(context, SEA_SHELL_WATER,  configuredFeatures.getOrThrow(SConfiguredFeatures.SEA_SHELLS),
       //         CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        ...
        register(context, SEA_GLASS,  configuredFeatures.getOrThrow(SFConfiguredFeatures.SEA_GLASS),
                VegetationPlacements.worldSurfaceSquaredWithCount(2));

        register(context, SEA_STAR_LAND,  configuredFeatures.getOrThrow(SFConfiguredFeatures.SEA_STARS),
                VegetationPlacements.worldSurfaceSquaredWithCount(1));

        register(context, JUMBLED_SHELLY_SAND_PATCH,  configuredFeatures.getOrThrow(SFConfiguredFeatures.JUMBLED_SHELLY_SAND_PATCH),
                ImmutableList.of(
        ...
        register(context, SCATTERED_SHELLY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.SCATTERED_SHELLY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, MIXED_SHELLY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.MIXED_SHELLY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, GRAVELY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.GRAVELY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, ROCKY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.ROCKY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, RED_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.RED_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, PURPLE_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.PURPLE_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, PINK_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.PINK_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, BLUE_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.BLUE_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, BLUE_MIXED_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.BLUE_MIXED_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, RED_MIXED_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.RED_MIXED_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, SAND_TAG_PATCH_PLACED,  configuredFeatures.getOrThrow(SFConfiguredFeatures.SAND_TAG_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(1),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome()
        ...
        register(context, FLOATSOME,  configuredFeatures.getOrThrow(SFConfiguredFeatures.FLOATSOME),
                VegetationPlacements.worldSurfaceSquaredWithCount(1));
