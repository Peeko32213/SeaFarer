...
public class SeafarerPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, BEACHGRASS_FAN_PLACED, configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.BEACHGRASS_FAN), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(16),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, SEA_HOLLY_PLACED, configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SEA_HOLLY), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, SEA_THRIFT_PLACED, configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SEA_THRIFT), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, COASTAL_LAVENDER_PLACED, configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.COASTAL_LAVENDER), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, COASTAL_WILDFLOWER_PLACED, configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.COASTAL_WILDFLOWER), ImmutableList.of(
                RarityFilter.onAverageOnceEvery(1),
                InSquarePlacement.spread(),
                CountPlacement.of(6),
                PlacementUtils.FULL_RANGE,
        ...
        register(context, ALGAE_BOULDER_PLACED, configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.ALGAE_BOULDER), ImmutableList.of(
        ...
        register(context, SEA_SHELL_LAND,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SEA_SHELLS),
      ...
      // register(context, SEA_SHELL_WATER,  configuredFeatures.getOrThrow(SConfiguredFeatures.SEA_SHELLS),
       //         CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        ...
        register(context, SEA_GLASS,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SEA_GLASS),
                VegetationPlacements.worldSurfaceSquaredWithCount(2));

        register(context, SEA_STAR_LAND,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SEA_STARS),
                VegetationPlacements.worldSurfaceSquaredWithCount(1));

        register(context, JUMBLED_SHELLY_SAND_PATCH,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.JUMBLED_SHELLY_SAND_PATCH),
                ImmutableList.of(
        ...
        register(context, SCATTERED_SHELLY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SCATTERED_SHELLY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, MIXED_SHELLY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.MIXED_SHELLY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, GRAVELY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.GRAVELY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, ROCKY_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.ROCKY_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, RED_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.RED_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, PURPLE_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.PURPLE_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, PINK_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.PINK_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, BLUE_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.BLUE_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, BLUE_MIXED_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.BLUE_MIXED_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, RED_MIXED_SPRINKLED_SAND_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.RED_MIXED_SPRINKLED_SAND_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(300),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
        ...
        register(context, SAND_TAG_PATCH_PLACED,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.SAND_TAG_PATCH),
                ImmutableList.of(
                        RarityFilter.onAverageOnceEvery(1),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome()
        ...
        register(context, FLOATSOME,  configuredFeatures.getOrThrow(SeafarerConfiguredFeatures.FLOATSOME),
                VegetationPlacements.worldSurfaceSquaredWithCount(1));
