...
public class SeaBlocks {
    ...
    public static final RegistryObject<Block> WHITE_SEA_GLASS_BRICKS = registerBlock("white_sea_glass_bricks", () -> new Block(SeaBlockProperties.seaGlassSolid(MapColor.SNOW)));
    ...
    public static final RegistryObject<Block> WHITE_NETTED_SEA_GLASS_LAMP = registerBlock("white_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.SNOW)));
    public static final RegistryObject<Block> WHITE_MOSAIC_SEA_GLASS_LAMP = registerBlock("white_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.SNOW)));
    ...
    public static final RegistryObject<Block> LIGHT_GRAY_MOSAIC_SEA_GLASS_LAMP = registerBlock("light_gray_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_LIGHT_GRAY)));
    ...
    public static final RegistryObject<Block> GRAY_MOSAIC_SEA_GLASS_LAMP = registerBlock("gray_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_GRAY)));
    ...
    public static final RegistryObject<Block> BLACK_NETTED_SEA_GLASS_LAMP = registerBlock("black_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_BLACK)));
    public static final RegistryObject<Block> BLACK_MOSAIC_SEA_GLASS_LAMP = registerBlock("black_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_BLACK)));
    ...
    public static final RegistryObject<Block> BROWN_MOSAIC_SEA_GLASS_LAMP = registerBlock("brown_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_BROWN)));
    ...
    public static final RegistryObject<Block> RED_NETTED_SEA_GLASS_LAMP = registerBlock("red_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_RED)));
    public static final RegistryObject<Block> RED_MOSAIC_SEA_GLASS_LAMP = registerBlock("red_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_RED)));
    ...
    public static final RegistryObject<Block> ORANGE_NETTED_SEA_GLASS_LAMP = registerBlock("orange_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_ORANGE)));
    public static final RegistryObject<Block> ORANGE_MOSAIC_SEA_GLASS_LAMP = registerBlock("orange_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_ORANGE)));
    ...
    public static final RegistryObject<Block> YELLOW_NETTED_SEA_GLASS_LAMP = registerBlock("yellow_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_YELLOW)));
    public static final RegistryObject<Block> YELLOW_MOSAIC_SEA_GLASS_LAMP = registerBlock("yellow_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_YELLOW)));
    ...
    public static final RegistryObject<Block> LIME_NETTED_SEA_GLASS_LAMP = registerBlock("lime_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_LIGHT_GREEN)));
    public static final RegistryObject<Block> LIME_MOSAIC_SEA_GLASS_LAMP = registerBlock("lime_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_LIGHT_GREEN)));
    ...
    public static final RegistryObject<Block> GREEN_NETTED_SEA_GLASS_LAMP = registerBlock("green_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_GREEN)));
    public static final RegistryObject<Block> GREEN_MOSAIC_SEA_GLASS_LAMP = registerBlock("green_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_GREEN)));
    ...
    public static final RegistryObject<Block> CYAN_MOSAIC_SEA_GLASS_LAMP = registerBlock("cyan_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_CYAN)));

    // light blue sea glass
    public static final RegistryObject<Block> LIGHT_BLUE_PEBBLED_SEA_GLASS = registerBlock("light_blue_pebbled_sea_glass", () -> new Block(SeaBlockProperties.seaGlassSolid(MapColor.COLOR_LIGHT_BLUE)));
    public static final RegistryObject<Block> LIGHT_BLUE_SEA_GLASS = registerBlock("light_blue_sea_glass", () -> new GlassBlock(SeaBlockProperties.seaGlass(MapColor.COLOR_LIGHT_BLUE)));
    ...
    public static final RegistryObject<Block> BLUE_MOSAIC_SEA_GLASS_LAMP = registerBlock("blue_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_BLUE)));
    ...
    public static final RegistryObject<Block> PURPLE_MOSAIC_SEA_GLASS_LAMP = registerBlock("purple_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_PURPLE)));

    // magenta sea glass
    public static final RegistryObject<Block> MAGENTA_PEBBLED_SEA_GLASS = registerBlock("magenta_pebbled_sea_glass", () -> new Block(SeaBlockProperties.seaGlassSolid(MapColor.COLOR_MAGENTA)));
    public static final RegistryObject<Block> MAGENTA_SEA_GLASS = registerBlock("magenta_sea_glass", () -> new GlassBlock(SeaBlockProperties.seaGlass(MapColor.COLOR_MAGENTA)));
    public static final RegistryObject<Block> MAGENTA_SEA_GLASS_PANE = registerBlock("magenta_sea_glass_pane", () -> new IronBarsBlock(SeaBlockProperties.seaGlass(MapColor.COLOR_MAGENTA)));
    public static final RegistryObject<Block> MAGENTA_SEA_GLASS_BRICKS = registerBlock("magenta_sea_glass_bricks", () -> new Block(SeaBlockProperties.seaGlassSolid(MapColor.COLOR_MAGENTA)));
    ...
    public static final RegistryObject<Block> MAGENTA_SEA_GLASS_LAMP = registerBlock("magenta_sea_glass_lamp", () -> new SeaDirectionalBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_MAGENTA)));
    public static final RegistryObject<Block> MAGENTA_NETTED_SEA_GLASS_LAMP = registerBlock("magenta_netted_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_MAGENTA)));
    public static final RegistryObject<Block> MAGENTA_MOSAIC_SEA_GLASS_LAMP = registerBlock("magenta_mosaic_sea_glass_lamp", () -> new RotatedPillarBlock(SeaBlockProperties.seaGlassLamp(MapColor.COLOR_MAGENTA)));
    ...
    public static final RegistryObject<Block> CLAM_SHELL_PILLAR = registerBlock("clam_shell_pillar", () -> new RotatedPillarBlock(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_YELLOW)));

    public static final RegistryObject<Block> HORN_SHELL_BRICKS = registerBlock("horn_shell_bricks", () -> new Block(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_ORANGE)));
    ...
    public static final RegistryObject<Block> HORN_SHELL_PILLAR = registerBlock("horn_shell_pillar", () -> new RotatedPillarBlock(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_YELLOW)));

    public static final RegistryObject<Block> SPIKY_SHELL_BRICKS = registerBlock("spiky_shell_bricks", () -> new Block(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_PINK)));
    ...
    public static final RegistryObject<Block> SPIKY_SHELL_PILLAR = registerBlock("spiky_shell_pillar", () -> new RotatedPillarBlock(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_PINK)));

    public static final RegistryObject<Block> SPIRAL_SHELL_BRICKS = registerBlock("spiral_shell_bricks", () -> new Block(SeaBlockProperties.shellBlock(MapColor.COLOR_LIGHT_BLUE)));
    ...
    public static final RegistryObject<Block> SPIRAL_SHELL_PILLAR = registerBlock("spiral_shell_pillar", () -> new RotatedPillarBlock(SeaBlockProperties.shellBlock(MapColor.COLOR_LIGHT_BLUE)));

    public static final RegistryObject<Block> SWIRL_SHELL_BRICKS = registerBlock("swirl_shell_bricks", () -> new Block(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_MAGENTA)));
    ...
    public static final RegistryObject<Block> SWIRL_SHELL_PILLAR = registerBlock("swirl_shell_pillar", () -> new RotatedPillarBlock(SeaBlockProperties.shellBlock(MapColor.TERRACOTTA_MAGENTA)));

    public static final RegistryObject<Block> PYRAMID_SHELL_BRICKS = registerBlock("pyramid_shell_bricks", () -> new Block(SeaBlockProperties.shellBlock(MapColor.SAND)));
    ...
    public static final RegistryObject<Block> PYRAMID_SHELL_PILLAR = registerBlock("pyramid_shell_pillar", () -> new RotatedPillarBlock(SeaBlockProperties.shellBlock(MapColor.SAND)));
    ...
    public static final RegistryObject<Block> BLUE_VOLCANIC_GRASS = registerBlock("blue_volcanic_grass", () -> new BeachPlantBlock(SeaBlockProperties.PLANT));
    public static final RegistryObject<Block> POTTED_BLUE_VOLCANIC_GRASS = registerBlockWithoutItem("potted_blue_volcanic_grass", () -> new FlowerPotBlock(SeaBlocks.BLUE_VOLCANIC_GRASS.get(), registerFlowerPot()));
