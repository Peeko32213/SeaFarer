    ...
    public static final RegistryObject<CreativeModeTab> SEAFARER_TAB = CREATIVE_TABS.register("seafarer_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(SeafarerItems.SEAFARER.get()))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        // horseshoe crab
                        output.accept(SeafarerItems.HORSESHOE_CRAB_SPAWN_EGG.get());
                        ...
                        // magmaw
                        output.accept(SeafarerItems.MAGMAW_SPAWN_EGG.get());

                        // manta ray
                        output.accept(SeafarerItems.MANTA_RAY_SPAWN_EGG.get());

                        // shore crab
                        output.accept(SeafarerItems.SHORE_CRAB_SPAWN_EGG.get());
                        ...
                        // snake mackerel
                        output.accept(SeafarerItems.SNAKE_MACKEREL_SPAWN_EGG.get());

                        // sunfish
                        output.accept(SeafarerItems.SUNFISH_SPAWN_EGG.get());
