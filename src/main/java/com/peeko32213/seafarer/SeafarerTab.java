...
public class SeafarerTab {
    ...
    public static final RegistryObject<CreativeModeTab> TAB = DEF_REG.register(Seafarer.MOD_ID, () -> CreativeModeTab.builder()
            ...
            .displayItems((enabledFeatures, output) -> {
                    ...
                    // food
                    output.accept(SFItems.RAW_SHORE_CRAB_LEG.get());
                    output.accept(SFItems.COOKED_SHORE_CRAB_LEG.get());
                    output.accept(SFItems.RAW_HORSESHOE_CRAB.get());
                    output.accept(SFItems.COOKED_HORSESHOE_CRAB.get());
                    output.accept(SFItems.RAW_MARINE_IGUANA_TAIL.get());
                    output.accept(SFItems.COOKED_MARINE_IGUANA_TAIL.get());
                    ...
                    output.accept(SFItems.SEA_SALT.get());
                    ...
                    output.accept(SFItems.METAL_CAN.get());
...
//                    output.accept(SeafarerItems.SQUIRRELFISH_BUCKET.get());
                    ...
                    output.accept(SFBlocks.SPIKY_SHELL_BRICK_STAIRS.get());
                    output.accept(SFBlocks.SPIKY_SHELL_BRICK_SLAB.get());
                    output.accept(SFBlocks.SPIKY_SHELL_PILLAR.get());
                    output.accept(SFBlocks.CLAM_SHELL_BRICKS.get());
                    output.accept(SFBlocks.CLAM_SHELL_BRICK_STAIRS.get());
                    output.accept(SFBlocks.CLAM_SHELL_BRICK_SLAB.get());
                    output.accept(SFBlocks.CLAM_SHELL_PILLAR.get());
                    output.accept(SFBlocks.HORN_SHELL_BRICKS.get());
                    output.accept(SFBlocks.HORN_SHELL_BRICK_STAIRS.get());
                    output.accept(SFBlocks.HORN_SHELL_BRICK_SLAB.get());
                    output.accept(SFBlocks.HORN_SHELL_PILLAR.get());
                    output.accept(SFBlocks.SWIRL_SHELL_BRICKS.get());
                    output.accept(SFBlocks.SWIRL_SHELL_BRICK_STAIRS.get());
                    output.accept(SFBlocks.SWIRL_SHELL_BRICK_SLAB.get());
                    output.accept(SFBlocks.SWIRL_SHELL_PILLAR.get());
                    output.accept(SFBlocks.SPIRAL_SHELL_BRICKS.get());
                    output.accept(SFBlocks.SPIRAL_SHELL_BRICK_STAIRS.get());
                    output.accept(SFBlocks.SPIRAL_SHELL_BRICK_SLAB.get());
                    output.accept(SFBlocks.SPIRAL_SHELL_PILLAR.get());
                    output.accept(SFBlocks.PYRAMID_SHELL_BRICKS.get());
                    output.accept(SFBlocks.PYRAMID_SHELL_BRICK_STAIRS.get());
                    output.accept(SFBlocks.PYRAMID_SHELL_BRICK_SLAB.get());
