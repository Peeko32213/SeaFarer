    ...
    public static final RegistryObject<CreativeModeTab> TAB = DEF_REG.register(SeaFarer.MODID, () -> CreativeModeTab.builder()
            ...
            .displayItems((enabledFeatures, output) -> {
                for(RegistryObject<Item> item : SFItems.ITEMS.getEntries()){
                    ...
                    output.accept(SFBlocks.WHITE_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.WHITE_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_FISHBOWL_WHITE.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.BROWN_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_BUST_BROWN.get());
                    output.accept(SFBlocks.RED_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.RED_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.RED_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.RED_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.RED_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.RED_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.RED_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.RED_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.RED_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.RED_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_THIN_RED.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.ORANGE_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_CURVY_ORANGE.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.YELLOW_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_PIPE_YELLOW.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.LIME_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_CURVY_LIME.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.GREEN_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_THIN_GREEN.get());
                    ...
                    output.accept(SFBlocks.PURPLE_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.PURPLE_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_FISHBOWL_PURPLE.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_PEBBLES.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_PEBBLED.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_BLOCK.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_PANE.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_BRICKS.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_BRICKS_STAIRS.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_BRICKS_SLAB.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_TILES.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_TILES_STAIRS.get());
                    output.accept(SFBlocks.PINK_SEAGLASS_TILES_SLAB.get());
                    output.accept(SFBlocks.SEAGLASS_BOTTLE_PIPE_PINK.get());
