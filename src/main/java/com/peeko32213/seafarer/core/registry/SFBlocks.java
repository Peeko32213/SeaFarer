...
public class SFBlocks {
    ...
    // Properties
    public static final BlockBehaviour.Properties SEA_GLASS_LAMP_PROPERTIES = BlockBehaviour.Properties.of().strength(0.5F, 0.5F).sound(SFSoundTypes.SEAGLASS).lightLevel(state -> 15);
    ...
    public static final RegistryObject<Block> AZURE_SEA_GLASS_LAMP = createBlock("azure_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> ROSE_SEA_GLASS_LAMP = createBlock("rose_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> LILAC_SEA_GLASS_LAMP = createBlock("lilac_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> SEAFOAM_SEA_GLASS_LAMP = createBlock("seafoam_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> CHARTREUSE_SEA_GLASS_LAMP = createBlock("chartreuse_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> CITRINE_SEA_GLASS_LAMP = createBlock("citrine_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> AMBER_SEA_GLASS_LAMP = createBlock("amber_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> SCARLET_SEA_GLASS_LAMP = createBlock("scarlet_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> UMBER_SEA_GLASS_LAMP = createBlock("umber_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> PEARLY_SEA_GLASS_LAMP = createBlock("pearly_sea_glass_lamp", () -> new SFDirectionalBlock(SEA_GLASS_LAMP_PROPERTIES));
    ...
    public static final RegistryObject<Block> OLD_BOARDS = createBlock("old_boards", () -> new OldBoardsBlock(BlockBehaviour.Properties.of().sound(SoundType.WOOD).noCollission().noOcclusion().pushReaction(PushReaction.DESTROY).ignitedByLava().strength(0.1F).mapColor(MapColor.WOOD)));

    public static final RegistryObject<Block> FISHING_NET = registerPlaceOnWaterBlockItem("fishing_net",
            () -> new FishingNet(BlockBehaviour.Properties
                    .copy(Blocks.STONE)
                    .noOcclusion()
                    .strength(0.2F)
