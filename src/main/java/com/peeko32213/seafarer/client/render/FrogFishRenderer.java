...
public class FrogFishRenderer<T extends LivingEntity & GeoAnimatable> extends GeoEntityRenderer<T> {

    public FrogFishRenderer(EntityRendererProvider.Context context, GeoModel<T> model) {
        super(context, model);
    }
